  ...
  const questions: QuestionInterface[] = [
    {
      ...
      answer: 'Скалы Петра Гронского. Станция электрички - о.п 479км (направление: Екатеринбург - Нижний Тагил)',
    },

    {
      id: 2,
      question: 'Какого числа выезд?',
      answer: 'На данный момент день выезда - 1 апреля 2024 года',
    },
...

    {
      ...
      answer: 'Туда и обратно вместе - 64 рубля (если Яндекс не врет. раньше около 180 было). Я возьму сразу на всех, потом на карту можно будет кинуть',
    },
...

    {
      ...
      answer: ' На любой из этих электричек: 12:45 | 14:35 | 15:30 | 18:30: 19:35',
