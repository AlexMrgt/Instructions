...
const chortovoGorodisheRock = 'Скалы Чертово городище. Станция электрички - Исеть (направление: Екатеринбург - Нижний Тагил)'
...
const Questions = () => {
  ...
  const questions: QuestionInterface[] = [
...

    {
      ...
      answer: 'На данный момент день выезда - 31 мая 2025 года',
    },
...

    {
      ...
      answer: 'Туда и обратно вместе - 160 рублей. Я возьму сразу на всех, потом на карту можно будет кинуть',
    },
...

    {
      ...
      answer: 'Да, ТАК И БУДЕТ, т.к. стартовая точка нашего электрона не ж/д вокзал.',
    },
