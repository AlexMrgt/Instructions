...
const Questions = () => {
  ...
  const questions: QuestionInterface[] = [
...

    {
      ...
      answer: 'На данный момент день выезда - 10 августа 2024 года',
    },
...

    {
      ...
      answer: 'Туда и обратно вместе - 74 рубля. Я возьму сразу на всех, потом на карту можно будет кинуть',
    },
