...
const Fairytale: React.FC = () => {
  const last =
    "Ну вот и все) Не профессиональная литература, но от всего сердца. Это писалось для тебя. Но ты и так это знаешь. И ты знаешь, что я твой миниатюрный рыцарь с большим сердцем. Хочется, чтобы ты была рядом. Не могу не пытаться обратить твои чувства ко мне.";
